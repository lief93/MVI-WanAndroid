...
private object LibraryVersion {
    ...
    const val BYE_BURGER = "1.2.3"
    const val SMART_REFRESH = "1.1.0-alpha-21"
    const val BASE_RECYCLERVIEW_ADAPTER_HELPER = "2.9.50"
    const val CONVERT_GSON = "2.9.0"
}
...
object LibraryDependency {
    ...
    const val BYE_BURGER = "com.github.githubwing:ByeBurger:${LibraryVersion.BYE_BURGER}"
    const val SMART_REFRESH_LAYOUT = "com.scwang.smartrefresh:SmartRefreshLayout:${LibraryVersion.SMART_REFRESH}"
    const val SMART_REFRESH_HEADER = "com.scwang.smartrefresh:SmartRefreshHeader:${LibraryVersion.SMART_REFRESH}"
    const val BASE_RECYCLERVIEW_ADAPTER_HELPER = "com.github.CymChad:BaseRecyclerViewAdapterHelper:${LibraryVersion.BASE_RECYCLERVIEW_ADAPTER_HELPER}"
    const val CONVERT_GSON = "com.squareup.retrofit2:converter-gson:${LibraryVersion.CONVERT_GSON}"
}
