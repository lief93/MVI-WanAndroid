...
dependencies {
    ...
    api(LibraryDependency.SMART_REFRESH_LAYOUT)
    api(LibraryDependency.SMART_REFRESH_HEADER)
    api(LibraryDependency.BASE_RECYCLERVIEW_ADAPTER_HELPER)
    api(LibraryDependency.CONVERT_GSON)
